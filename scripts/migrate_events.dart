...
//
// 정치 카피("YOON FREE", "CCP OUT" 등)는 Apple 심사 대비를 위해 W5.5에서
// 톤다운 일괄 처리한다.
...
final List<Map<String, dynamic>> _eventSeed = [
  {
    ...
    "slogans": ["YOON FREE", "CCP OUT", "WE GO TOGETHER", "SAVE KOREA"],
  ...
  },
  {
    ...
    "slogans": ["MAGA WITH ROK", "WE GO TOGETHER", "SAVE KOREA"],
  ...
  },
  {
    ...
    "locationQuery": "부산 서면",
    "slogans": ["SAVE KOREA", "WE GO TOGETHER"],
    "items": ["명찰", "모임 공지문"],
  ...
  },
  {
    ...
    "slogans": ["윤통복귀", "YOON FREE", "SAVE KOREA"],
    "items": ["태극기", "피켓", "우비"],
    "description": "윤통복귀와 자유민주 질서 회복을 촉구하는 서울역 집중 집회입니다. 퇴근 시간대 집중 확산을 목표로 합니다.",
    "isFeatured": true,
  },
  {
    "status": "정기 일정",
  ...
  },
  {
    ...
    "slogans": ["MAGA WITH ROK", "WE GO TOGETHER"],
    "items": ["줌 링크", "브리핑 자료"],
  ...
  },
  {
    ...
    "locationQuery": "여의도공원",
    "slogans": ["SAVE KOREA", "YOON FREE", "CCP OUT"],
    "items": ["태극기", "성조기", "피켓", "간식"],
    "description": "여의도 중심 대규모 자유행동 집회입니다. 집결/공유/확산을 동시에 만드는 상징 집회로 기획된 일정입니다.",
    "isFeatured": true,
  },
];
